...
const {sendTweet,showTweet,removeTweet,like,unlike,addComment,getComments,deleteComment} = require("../controller/tweet.controller.js")
...
router.route("/delete-tweet").delete(verifyJwt,removeTweet)
